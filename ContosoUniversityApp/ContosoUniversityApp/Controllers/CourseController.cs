...
namespace ContosoUniversityApp.Controllers
{
    public class CourseController : Controller
    {
        ...
        {
            var departmtnsQuery = from d in db.Departments orderby d.Name select d;
            ViewBag.DepartmentID = new SelectList(departmtnsQuery, "DepartmentID", "Name", selectedDepartment);
        }
